...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'diysum.wast';
  var wasmBinaryFile = 'diysum.wasm';
  var asmjsCodeFile = 'diysum.temp.asm.js';
...
var real__diy_sum = asm["_diy_sum"]; asm["_diy_sum"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__diy_sum.apply(null, arguments);
};
...
var _diy_sum = Module["_diy_sum"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_diy_sum"].apply(null, arguments) };
